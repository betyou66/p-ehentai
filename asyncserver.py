...
class Server:
    ...
    def __init__(self):
        ...
        #self.server.setsockopt(socket.SOL_SOCKET, socket.SO_SNDBUF, 163840)
        #self.server.setsockopt(socket.SOL_SOCKET, socket.SO_KEEPALIVE, 1)
        self.context = ssl.create_default_context(ssl.Purpose.CLIENT_AUTH)
        #self.context.load_cert_chain(certfile='/home/h/mimt/cert/server.crt',keyfile='/home/h/mimt/cert/server.key')
        self.context.keylog_filename = "keys.log"
    ...
    async def searchfile(self):
        ...
        if(self.ducu == False):
            ...
            #lxs.Prx.ipw = "104.20.18.168"
            #lxs.Prx.ipw = '127.0.0.1'
    ...
    async def run(self):
        ...
        while True:
            ...
            #conn.setsockopt(socket.SOL_SOCKET, socket.SO_SNDBUF, 163840)
